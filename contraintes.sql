...
then raise_application_error('-20001', 'Vous avez d̩passer la date limite d emprunt pour un document');
end if;
end;
/
...
then raise_application_error('-20001', 'Ce document est deja emprunt̩.');
end if;
end;
/
